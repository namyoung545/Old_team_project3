$(document).ready(() => {
    ...
    function callFireDamagePropertyChart(fireDamageProperty, fireDamageByED) {
        ...
        let $chartDamage_ny = $('#chartDamage_ny');
        createChartGraph($chartDamage_ny, chartData, 'line');
    ...
    function callFiresChart(firesData, firesCauseED) {
        ...
        let $chartFires_ny = $('#chartFires_ny');
        createChartGraph($chartFires_ny, chartData, 'bar');
    }
    ...
    function callFireCauseChart(firesCauseYear) {
        ...
        let $chartCause_ny = $('#chartCause_ny');
        createChartGraph($chartCause_ny, chartData, 'doughnut', chartOptions);

        let $labelCause_ny = $('#labelCause_ny');
        $labelCause_ny.empty(); // 기존 내용 초기화
        ...
        firesCauseData.forEach((value, index) => {
            if (index < 4) {
                ...
                <div class="label-item">
                    ...
                    <div class="label-value">${labelValue}건 (${percentage}%)</div>
                </div>
                `;
                $labelCause_ny.append(labelHtml);
            }
        });
    }
    ...
    function callFireCasualtiesChart(fireDeaths, fireInjuries) {
        ...
        let chartCasualties = $('#chartInjuries_ny');
